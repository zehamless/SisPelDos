        ...
        class="btn btn-neutral">
            <div class="flex items-center gap-x-2 w-full">
                ...
                <div class="flex flex-col w-full">
                    ...
                    <span class="text-xs text-gray-400 text-right" id="selectd-prodi">${prodi}</span>
...
async function registerAccount() {
    ...
    formData.append('nama', data.nm_sdm);
    formData.append('jenis_kelamin', data.jk);
    formData.append('universitas', data.namapt);
    formData.append('prodi', data.namaprodi);
